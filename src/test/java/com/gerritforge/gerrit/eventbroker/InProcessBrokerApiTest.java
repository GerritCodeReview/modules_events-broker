...
public class InProcessBrokerApiTest {
  ...
  ContextAwareConsumer<Event> eventConsumer;
  ...
  public void shouldRegisterConsumerPerTopic() {
    ContextAwareConsumer<Event> secondConsumer = mockEventConsumer();
  ...
  public void shouldReturnMapOfConsumersPerTopic() {
    ContextAwareConsumer<Event> firstConsumerTopicA = mockEventConsumer();

    ContextAwareConsumer<Event> secondConsumerTopicA = mockEventConsumer();
    ContextAwareConsumer<Event> thirdConsumerTopicB = mockEventConsumer();
  ...
  public void shouldReconnectSubscribers() {
    ...
    ContextAwareConsumer<Event> newConsumer = mockEventConsumer();
  ...
  private static class Subscriber<T> implements ContextAwareConsumer<T> {

    @Override
    public void accept(T t, MessageContext ctx) {}
  }

  private <T> ContextAwareConsumer<T> mockEventConsumer() {
