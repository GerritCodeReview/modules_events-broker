...
public class InProcessBrokerApiTest {
  ...
  @Test
  public void shouldRegisterContextAwareConsumerWithGroupIdPerTopic() {
    ...
    assertThat(brokerApiUnderTest.topicSubscribersWithContextWithGroupId().size()).isEqualTo(2);
  }
