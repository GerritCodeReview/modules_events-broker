...
public class BrokerApiPluginListenerTest {
  ...
  private static class TestListener implements BrokerApiPluginListener {
    ...
    private RuntimeException unboundFailure;
    ...
    @Override
    public void onBrokerApiBound() {
      bound++;
      subscribedTo = brokerApiItem.getPluginName();
    }

    @Override
    public void onBrokerApiUnbound() {
      unbound++;
      subscribedTo = null;
      if (unboundFailure != null) {
        throw unboundFailure;
      }
    }

    void failOnUnboundWith(RuntimeException e) {
      unboundFailure = e;
    }
  }
  ...
  public void shouldNotifyWhenThePluginBindingTheBrokerStarts() {
    ...
    assertThat(listenerUnderTest.bound).isEqualTo(1);
  }
  ...
  public void shouldNotNotifyWhenAPluginBindingNoBrokerStarts() {
    ...
    assertThat(listenerUnderTest.bound).isEqualTo(0);
  }
  ...
  public void shouldNotifyWhenTheSubscribedBrokerPluginStops() {
    ...
    assertThat(listenerUnderTest.unbound).isEqualTo(1);
  }
  ...
  public void shouldNotNotifyWhenAPluginOtherThanTheBrokerStops() {
    ...
    assertThat(listenerUnderTest.unbound).isEqualTo(0);
  }
  ...
  public void shouldNotPropagateListenerFailuresWhenTheBrokerPluginStops() {
    ...
    listenerUnderTest.onStartPlugin(pluginNamed(BROKER_PLUGIN));
    brokerHandle.remove();
    listenerUnderTest.failOnUnboundWith(new IllegalStateException("listener failed"));
