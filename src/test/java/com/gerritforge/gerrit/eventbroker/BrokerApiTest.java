...
public class BrokerApiTest {
  ...
  public void shouldRegisterConsumerPerTopic()
    ...
    brokerApiUnderTest.send("topic", wrap(eventForTopic)).get(1, TimeUnit.SECONDS);
    brokerApiUnderTest.send("topic2", wrap(eventForTopic2)).get(1, TimeUnit.SECONDS);
  ...
  public void shouldDeliverAsynchronouslyEventToAllRegisteredConsumers()
    ...
    brokerApiUnderTest.send("topic", wrap(event)).get(1, TimeUnit.SECONDS);
  ...
  public void shouldBeAbleToSwitchBrokerAndReconnectSubscribers()
    ...
    clearInvocations(eventConsumer);
    secondaryBroker.send("topic", wrap(eventForTopic)).get(1, TimeUnit.SECONDS);
