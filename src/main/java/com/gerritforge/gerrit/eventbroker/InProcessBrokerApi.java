...
public class InProcessBrokerApi implements BrokerApi {
  ...
  @Override
  public void receiveAsync(String topic, AcknowledgementAwareConsumer<Event> eventConsumer) {
    topicSubscribers.add(topicSubscriber(topic, eventConsumer));
  }

  @Override
  public void receiveAsync(
      String topic, String groupId, AcknowledgementAwareConsumer<Event> eventConsumer) {
