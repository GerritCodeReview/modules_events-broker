...
public class InProcessBrokerApi implements BrokerApi {
  ...
  @Override
  public void receiveAsyncWithPartition(String topic, String partition, String groupId, AckAwareConsumer<Event> consumer) {

  }

  @Override
  public void receiveAsyncWithPartition(String topic, String partition, AckAwareConsumer<Event> consumer) {
