...
public interface BrokerApi {
   ...
   *
   * Call the consumer for every message received from a topic.
   * The message is automatically acknowledged if the consumer
   * completes successfully, otherwise is put back on the topic
   * in case of any exceptions thrown.
   *
   * @param topic topic name
