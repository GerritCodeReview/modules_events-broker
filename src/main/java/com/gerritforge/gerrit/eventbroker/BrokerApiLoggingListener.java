 ...
 *
 * <p>NOTE: The messages that failed to be sent/received/acknowledged are not logged into the
 * message log, but their failure is logged at `severe` level in the Gerrit's error_log.
 */
