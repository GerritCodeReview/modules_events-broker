...
When `StreamEventPublisher` is used user can optionally bind an implementation of the `BrokerMetrics`
interface. This will allow to collect metrics about successful/failure stream events publishing. If
no binding is provided default implementation will skip collecting metrics:
